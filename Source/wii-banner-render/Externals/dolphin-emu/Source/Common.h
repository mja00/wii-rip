...
// Modifications:
//   - The `_M_SSE 0x301` definition below was previously enabled whenever
//     `defined __APPLE__` was true, regardless of host architecture. Apple
//     clang on Apple Silicon still defines __APPLE__, so the unguarded
//     condition pulled in x86 SSE intrinsics on arm64 and broke the build.
//     The condition is now restricted to actual x86 hosts (__x86_64__ /
//     __i386__).
...
#if (__GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ >= 3) || defined __APPLE__) && (defined(__x86_64__) || defined(__i386__))
#define _M_SSE 0x301
#endif
